    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="mb-0">Bantu Daftar</h3>
                <p class="text-sm mb-0">
                    Ini adalah formulir untuk memberikan bantuan pendaftaran akun pada website lokasihunian.com . <br>
                </p>
            </div>
        </div>

        <form action="{{ url('dashboard/bantu_daftar') }}" method="post">
            @csrf
